...
set(_osmium_include_path
        /home/hong/Documents/work/libosmium
        ~/Library/Frameworks
        /Library/Frameworks
...
set(Osmium_USE_IO TRUE)
if(Osmium_USE_IO)
    #message(WARNING "Osmium_USE_IO is ${Osmium_USE_IO}\n")
...
if(Osmium_USE_XML)
	...
	#message(WARNING "BZIP2_INCLUDE_DIR is ${BZIP2_INCLUDE_DIR}\n")
    else()
