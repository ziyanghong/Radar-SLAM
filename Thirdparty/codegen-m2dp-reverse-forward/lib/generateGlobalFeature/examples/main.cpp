...
static void main_generateGlobalFeature()
{
  ...
  emxInitArray_real_T(&pointCloudForward, 2);
  emxInitArray_real_T(&pointCloudOpposite, 2);
  ...
  generateGlobalFeature(img, max_selected_distance_tmp_tmp,
                        ...
                        max_selected_distance_tmp_tmp, featureForward,
                        pointCloudForward, featureReverse, pointCloudOpposite);
  emxDestroyArray_real_T(pointCloudOpposite);
  emxDestroyArray_real_T(pointCloudForward);
