...
class LaserReading: public AbstractReading {
	...
	/** Set maximum range. It sets the maximum range of the radar sensor. */
	void setMaxRange_(double _max){m_maxRange = _max;}
	/** Set laser pose. It sets the pose of the laser in the world. */
	void setLaserPose(const OrientedPoint2D& _pose);
	/** Set radar pose. It sets the pose of the radar in the world. */	 
	// void setRadarPose(const OrientedPoint2D& _pose);
	/** Set the points in the sensor reference frame. */	
	void setLocalCartesian(const std::vector<double> xs, const std::vector<double>ys);
