...
void LaserReadingRenderer::setLaserPoints(const std::vector<Point2D> *_points, const std::vector<double>& normals){
    ...
    // std::cout << "m_laserPoints size in LaserReadingRenderer: " << m_laserPoints->size() << std::endl; // Ziyang
    ...
    // std::cout << "m_GLUPoints size in LaserReadingRenderer: " << m_GLUPoints.size() << std::endl; // Ziyang
...
// 	glPopMatrix();
	...
	// std::cout <<"GL_POINTS index: " << index << std::endl; // Ziyang
    }
    glEnd();
