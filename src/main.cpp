...
int main(int argc, char **argv)
{
    ...
    std::cout << "Reading yaml config file: " << yaml_file << std::endl; 
    ...
    // std::cout << "nodeID: " << std::to_string(config_loader.nodeID) << std::endl; 
    ...
    else
    {
        ...
        // result_directory = parent_directory + "ro/" + std::to_string(config_loader.parameter)  + '/' + std::to_string(config_loader.nodeID) + "/";
